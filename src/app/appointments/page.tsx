...
const AppointmentPage: FC = (): JSX.Element => {
  ...
  const [currentStep, setCurrentStep] = useState<number>(1); // 1 => select dentist 2 => choose Time 3 => confirmed
      ...
      },
      {
        onSuccess: async (appointment) => {
          ...
          try {
            ...
            if (!emailResponse.ok)
              console.log("Failed to send confirmation email", emailResponse);
          } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
        ...
        {currentStep === 1 && (
          <DoctorSelectionStep
            ...
            onSelectedDentist={handleSelectDentist}
          />
        )}
